...
def addCircle(dwg, current_group, radius, center, data, palette):
    ...
    dwg.add(dwg.circle(center=(center[0], center[1]),
                       r=radius * 0.7,  # aqui talvez que un total de 0 no de un radio 0 si no un radio minimo?
                       stroke='gray',   # svgwrite.rgb(15, 15, 15, '%'),
                       fill='gainsboro'))
    dwg.add(dwg.circle(center=(center[0], center[1]),
                       r=radius * 0.7 * total,  # aqui talvez que un total de 0 no de un radio 0 si no un radio minimo?
